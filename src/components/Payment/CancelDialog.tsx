    ...
    >
      ...
      >
        ...
        {orderDetails.length > 0 && (
          <div
            className="max-h-[30vh] sm:max-h-56 overflow-y-auto mb-4 bg-red-50/60 rounded-xl p-2 border border-red-100"
            style={{
          ...
          >
            {orderDetails.map((od, idx) => (
              <div
                key={od.id}
                className="flex items-center gap-2 py-2 px-2 text-sm rounded hover:bg-red-100/60 transition flex-wrap mb-2"
              >
